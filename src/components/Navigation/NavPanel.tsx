...
const NavPanel: FC<{
  ...
  return (
    <div className="fixed right-0 z-[70] flex h-screen w-10/12 flex-col bg-slate-800 drop-shadow-md">
      <button
      ...
      <div className="flex flex-col">
        ...
        {session?.user ? (
          <button
            className="primary-btn mx-4 mt-4 bg-rose-400 hover:bg-rose-500 focus:bg-rose-500 focus:ring-rose-500 active:bg-rose-700 active:ring-rose-700"
